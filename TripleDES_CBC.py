...
def encrypt_3des_cbc(key1, key2, key3, iv, plaintext):
...
def decrypt_3des_cbc(key1, key2, key3, iv, ciphertext):
    cipher = DES3.new(key3, DES3.MODE_ECB)
...
iv = get_random_bytes(8)    # 8 bytes (64 bits) IV for CBC mode
plaintext = b'Hello, this is a secret message!'

ciphertext = encrypt_3des_cbc(key1, key2, key3, iv, plaintext)
print("Ciphertext:", ciphertext.hex())

decrypted_data = decrypt_3des_cbc(key1, key2, key3, iv, ciphertext)
